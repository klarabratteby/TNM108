...
# reduce it to only 3 principal features
...
#apply PCA on this scaled dataset.
...
#data visualization
#plot the malignant and benign classes based on the first two principal components
Xax=X_pca[:,0]
Yax=X_pca[:,1]
...
#a heatplot to see how the features mixed up to create the components.
...
#correlation plot of ‘worst’ values of the features.
